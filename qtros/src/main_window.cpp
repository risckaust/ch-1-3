...
void MainWindow::StateMachineSlot2(string state,string signal)
{
  QString qstate = QString::fromStdString(state);
  QString qsignal = QString::fromStdString(signal);
  ui.state_label2->setText(qstate);
  ui.signal_label2->setText(qsignal);
}
void MainWindow::StateMachineSlot3(string state,string signal)
{
  QString qstate = QString::fromStdString(state);
  QString qsignal = QString::fromStdString(signal);
