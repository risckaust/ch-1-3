		...
		while not rospy.is_shutdown():
			...
			if self.bgr_target.z > 0: # object is seen
				...
				if dxy < self.envelope :
					...
					print 'Object seen but not close enough. NOT descending..'
					print '    '
				...
				print 'object not see, going up gradually.....'
				print '    '
				
				if self.altK.z >= (self.ZGROUND + self.TRACK_ALT):
					print 'Reached Max allowed altitude..... still not seing an object'
