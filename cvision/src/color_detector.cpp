...
int main(int argc, char** argv)
{
    ...
    // create image converter class object
     cout << "created imageConverter"<< endl;
    //ImageConverter ic;
    //Node handle
    ros::NodeHandle n;

    /* get stc path as a ros parameter. Should be loaded by cvision/confgis/configs.yaml*/
    std::string s;
    ...
    {
      ROS_ERROR("Failed to get param 'src_path'");
      return 0;
    }
