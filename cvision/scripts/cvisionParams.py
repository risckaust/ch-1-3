...
def setParams(ns):
    ...
    rospy.set_param(ns+'/getColors/minRadius',5.0)                 # minimum cirlce radius to detect a color blob
    ...
    rospy.set_param(ns+'/getColors/pxRadius', 1.5)                  # radius multiplier for proximity mask
